...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <xsl:for-each select="//rdf:RDF/rdf:Description">
            ...
            <xsl:variable name="ID" select="substring-after($originalURI ,'http://vocabulary.odm2.org/medium/')"/>
            <xsl:value-of select="concat('mt:', $ID)"/> a skos:Concept ;
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>dct:source &lt;http://vocabulary.odm2.org/medium/&gt; ;</xsl:otherwise>
            </xsl:choose>
